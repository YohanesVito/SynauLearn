                    ...
                    <div className="grid grid-cols-3 gap-4">
                        {badges.map((badge) => (
                            <div key={badge.id} className="flex flex-col items-center">
                                <div
                                    className={`w-24 h-24 rounded-full flex items-center justify-center text-4xl mb-3 transition-all ${badge.unlocked
                                ...
                                <p
                                    className={`text-xs text-center leading-tight ${badge.unlocked ? 'text-white' : 'text-gray-600'
                                        }`}
                                >
                                    {badge.name}
                                </p>
